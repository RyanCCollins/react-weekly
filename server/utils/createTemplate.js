const createTemplate = (html, initialState) => `
  ...
  <body>
    <div id="app">${html}</div>
    <script type="text/javascript" src="/vendor.c7316cd8d580ca6b0edd.js"></script>
    <script type="text/javascript" src="/main.c77e1b034d5994a3e244.js"></script>
    <script>
